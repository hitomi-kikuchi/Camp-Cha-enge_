...
public final class insertconfirm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if(!udb.getName().equals("") && !udb.getYear().equals("") && !udb.getMonth().equals("") && !udb.getDay().equals("") &&  !udb.getType().equals("") && !udb.getComment().equals("")) { 
      ...
      out.write("        <form action=\"http://localhost:8080/JavaUserManagementSystem_ver1.0/insertresult.jsp\" method=\"POST\">\n");
      ...
      out.write("        ");
            ...
            //未入力のチェック
                ...
                if(udb.getName().equals("")) {
                    ...
                    check = "電話番号の項目が未入力です";
                }else if(udb.getComment().equals(null)) {
                    check = "コメントの項目が未入力です";
                }
            }
